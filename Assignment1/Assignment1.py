...
def task_6(df):
    ...
    for k in range(1,11):
        ...
        word_length = k
        word_occurs = 150
        most_accurate_words_probs_pos = {}
        most_accurate_words_probs_neg = {}
        ...
        if accuracy > most_accurate:
            ...
            k_most_accurate = k
            most_accurate_words_probs_pos = pos_probabilities
            most_accurate_words_probs_neg = neg_probabilities
    ...
    for i in range(len(data)):
        prediction = task_5(pos_prior,neg_prior,data[i],most_accurate_words_probs_pos,most_accurate_words_probs_neg)
        if(prediction == 0 and target[i] == 0):
            true_negatives = true_negatives +1
        elif(prediction == 0 and target[i] == 1):
            false_negatves = false_negatves + 1
